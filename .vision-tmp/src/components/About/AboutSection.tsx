        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`relative group animate-slide-up ${isVisible ? 'animate-fade-in' : ''}`} style={{ animationDelay: '0.2s' }}>
            ...
            <div className="relative glass-strong rounded-3xl p-8 hover-lift shadow-2xl shadow-black/40 border-white/20">
              ...
              {/* Floating badges */}
              <div className="absolute -top-4 -right-4 w-16 h-16 bg-gradient-apple rounded-full flex items-center justify-center text-2xl shadow-xl shadow-black/40 animate-float">
                💻
              </div>
              <div className="absolute -bottom-4 -left-4 w-14 h-14 bg-gradient-accent rounded-full flex items-center justify-center text-xl shadow-xl shadow-black/40 animate-float" style={{ animationDelay: '1s' }}>
                🚀
              </div>
            </div>
          </div>
          ...
          <div className={`space-y-8 animate-slide-up ${isVisible ? 'animate-fade-in' : ''}`} style={{ animationDelay: '0.4s' }}>
            ...
            <div className="glass rounded-3xl p-10 hover-lift shadow-xl shadow-black/30 border-white/10">
              ...
              <p className="text-base text-gray-400 leading-relaxed mb-6">
                "기술을 가진 사람만 콘텐츠를 만들 수 있는 세상"을 바꾸고자 개발되었습니다.
                저는 코드를 짜는 사람으로서, 복잡한 기술을 감추고 누구나 AI를 통해
                바이어에게 <span className="text-gradient-silver font-semibold">'보이는' 영상과 스토리</span>를 만들 수 있도록 시스템을 설계했습니다.
              </p>
              <p className="text-base text-gray-400 leading-relaxed mb-6">
                생성형 AI와 데이터 파이프라인을 결합해,
                제품이 스스로 팔리고 성장하는 구조를 코드로 구현하고 있습니다.
                TOTARO는 기술보다 결과를, 영상보다 메시지를 중요하게 생각합니다.
              </p>
              <p className="text-base text-gray-400 leading-relaxed">
                우리는 기술로 브랜드의 이야기가 세계로 전달되는 방식을 다시 설계하고 있습니다.
              </p>
            </div>
            ...
            <div className="glass rounded-3xl p-8 hover-lift shadow-xl shadow-black/30 border-white/10">
              ...
              <div className="space-y-6">
                {[
                  { 
                    name: 'Trynic AI', 
                    description: '패션/광고용 AI 영상·이미지 합성 서비스',
                    role: '모델 선택·의상 합성·레퍼런스 기반 생성'
                  },
                  { 
                    name: 'Medivu(메디뷰)', 
                    description: '의료영상 판독문 자동 생성/가명화 솔루션',
                    role: '병원 워크플로우 연계'
                  },
                  { 
                    name: 'TotaloadCert/수출 중고차 ERP', 
                    description: '말소→통관→선적 문서 자동화와 진행 현황 통합 조회',
                    role: '문서 자동화 시스템 구축'
                  },
                ].map((project, i) => (
                  <div key={i} className="relative group/project">
                    {/* Timeline line */}
                    {i < 2 && (
                      <div className="absolute left-6 top-12 w-0.5 h-16 bg-gradient-to-b from-gray-600 to-gray-800 opacity-50"></div>
                    )}
                    ...
                    <div className="flex items-start gap-6 p-6 bg-white/5 hover:bg-white/10 rounded-2xl transition-all hover:translate-x-2 border border-white/5 hover:border-white/20">
                      ...
                      <div className="flex-1">
                        <h6 className="font-bold text-lg mb-2 group-hover/project:text-white transition-colors">
                          {project.name}
                        </h6>
